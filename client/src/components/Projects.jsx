    ...
    <section className="my-4">
      ...
      <section className="gap-6 px-4 grid grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1">
        <div
          ...
          className="flex flex-row text-white gap-4 text-lg mb-2 bg-gray-100/50 h-42 rounded-xl w-80 p-4 cursor-pointer hover:bg-gray-500"
        >
      ...
      {expanded && (
        ...
        >
          <form
            ...
            className="flex flex-col gap-2 my-4 bg-gray-700 absolute z-10 top-24 left-[600px] rounded-xl h-96 w-64 p-4 font-bold text-white/80 justify-between"
          >
